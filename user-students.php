                ...
                <div class="overflow-off">
                    <div data-w-id="1fd6d305-6679-7cb9-fb3a-46939f11c7c4" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="w-clearfix">
                        <h1 class="home-hero-heading">
                            <span>
                                <span style="">Surveys for</span>
                                <span style="color:#0070DF"> students</span>
                            </span>
                            <br>
            ...
            <div class="home-hero-caption-block">
                ...
                <div class="overflow-off">
                    <p data-w-id="ed211d01-a9c7-1804-c0ae-c31feba0ee95" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; margin-top: 50px;" class="hero-para-two">
                        Next level thesis backed by data from real surveys.<br>Easy setup, fast results, all in one platform at affordable prices.
                    </p>
                </div>
                <div class="overflow-off">
                    <div class="hero-caption-buttons-one">
...
<!-- CSS for positioning and animation -->
<style>
    ...
    /* Hero Image Wrapper with Floating Images Positioned Absolutely */
    .home-hero-image-wrapper {
        position: relative;
        margin-top: 20px;
    }

    /* Floating Images - Overlapping Banner Girl */
    .floating-image {
        position: absolute;
        z-index: 2;
        opacity: 0;
    ...
    /* Specific Positions for Overlapping */
    .float-image-one {
        top: -50px;
        left: 20%;
    }
    ...
    /* Staggered Delay Using Custom Data Attribute */
    [data-delay] {
    ...
    /* Add styles similar to the class structure */
    .sm-mdsGridPlusItem-0-2-1955,
    .sm-mdsGridPlusItem-d144-0-2-2335,
    .sm-addFlex-0-2-1953,
    .sm-addFlex-d24-0-2-2334,
    .sm-mdsColumn-0-2-2038 {
        display: flex;
        justify-content: center;
        align-items: center;
        padding: 20px;
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        handleScrollAnimation(); // Run on page load as well
    });
    ...
    // Set up the IntersectionObserver to autoplay video on scroll
    const observer = new IntersectionObserver((entries) => {
        ...
        threshold: 0.5
    }); // 50% of the video should be visible

    observer.observe(video);

    // Function to play video forward or reverse
    function playVideo() {
        if (playingForward) {
            video.play();
        } else {
    ...
    // Reverse video playback frame-by-frame
    function reverseVideo() {
        ...
        const reverseInterval = setInterval(() => {
            if (video.currentTime <= 0) {
                ...
                video.currentTime -= 0.05; // Go back slightly
            }
        }, 50); // Adjust for speed
    }

    // Toggle playback direction when the video ends
