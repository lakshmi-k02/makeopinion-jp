...
<section class="homepage-hero-section hero desktop-only" style="background: #fff;padding-bottom: 150px;padding-top:130px;background-color: #FFF;background-image: url('./assets/images_new/bg-final.png');background-size: cover;background-position: 0 0">
...
<section class="strategy-section wf-section" style="background-color: #f9fafb;padding-top: 50px;background-image: url('./assets/images_new/bg4.png');background-size: cover;background-position: 0 0">
    <div class="page-container w-container">
        <div class="services-block">
            ...
            <h2 class="strategy-heading">より良い <span style="color:#0070DF">製品</span>. 効果的な <span style="color:#0070DF">マーケティング</span>. 売上 <span style="color:#0070DF">アップ</span>.</h2>
                ...
                <div class="offers-image-block">
                    <div class="offer-image-container" style="padding-left: 0px">
                        <div data-w-id="3c521391-adc0-dffd-f315-036d673d6d5c" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="growth-image">
                            <img src="./assets/images_new/quality-1.png" loading="lazy" sizes="(max-width: 479px) 75vw, (max-width: 767px) 61vw, (max-width: 991px) 70vw, (max-width: 1439px) 31vw, 420.5px" srcset="./assets/images_new/quality-1.webp 500w, 
