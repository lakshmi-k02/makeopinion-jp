                ...
                <div class="overflow-off">
                    <div data-w-id="1fd6d305-6679-7cb9-fb3a-46939f11c7c4" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d" class="w-clearfix">
                        <h1 class="home-hero-heading">
                            <span><span style="color:#0070DF">オールインワン</span>リサーチプラットフォーム</span><br>
                            アンケートを<span style="color:#0070DF">作成</span><br />
                            人々に<span style="color:#0070DF">届ける</span><br />
                            結果を<span style="color:#0070DF">理解する</span>
                        </h1>
                    </div>
                </div>
                <div class="overflow-off">
                    <p data-w-id="ed211d01-a9c7-1804-c0ae-c31feba0ee95" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d; margin-top: 50px" class="hero-para-two">ユーザーフレンドリーなプラットフォーム、高度な質問タイプと調査ロジック。<br>Botではない実際の人々からの回答データ収集と結果データの可視化が可能です。</p>
                </div>
                <div class="overflow-off">
                ...
                <div data-w-id="b3ab55ef-0bde-ad3e-dba8-997bea786104" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;">
                    <div class="home-hero-image-block">
                        <div class="banner-girl-image-block">
                            <img src="./assets/images_new/researcher-back.png" loading="lazy" sizes="(max-width: 479px) 94vw, (max-width: 767px) 56vw, (max-width: 991px) 54vw, (max-width: 1439px) 26vw, 347.671875px" srcset="
                          ./assets/images_new/researcher-back.png 500w, 
                          ./assets/images_new/researcher-back.png 770w" alt="Banner Girl Image" class="hero-main-image">
                        </div>
                        <div class="banner-float-images">
                            <div class="float-image-one">
                                <img src="./assets/images_new/researcher-1.png" loading="lazy" sizes="(max-width: 479px) 94vw, (max-width: 767px) 52vw, (max-width: 991px) 50vw, (max-width: 1439px) 25vw, 323.328125px" srcset="
                             ./assets/images_new/researcher-1.png 500w, 
                             ./assets/images_new/researcher-1.png 714w" alt="Banner Image One" class="float-image">
                            </div>
                            <div class="float-image-two">
                                <img src="./assets/images_new/researcher-2.png" loading="lazy" sizes="(max-width: 479px) 94vw, (max-width: 767px) 52vw, (max-width: 991px) 50vw, (max-width: 1439px) 25vw, 323.328125px" srcset="
                             ./assets/images_new/researcher-2.png 500w, 
                             ./assets/images_new/researcher-2.png 710w" alt="Finance" class="float-image">
                            </div>
                            <div class="float-image-three">
                                <img src="./assets/images_new/researcher-3.png" loading="lazy" sizes="(max-width: 479px) 94vw, (max-width: 767px) 52vw, (max-width: 991px) 50vw, (max-width: 1439px) 25vw, 323.328125px" srcset="
                             ./assets/images_new/researcher-3.png 500w, 
                             ./assets/images_new/researcher-3.png 714w" alt="Order Value" class="float-image">
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="home-hero-section-one wf-section mobile-only" style="background: #fff; padding-top: 80px; background-image: url('./assets/images_new/bg-final.png'); background-size: cover; background-position: center;">
    <div class="home-hero-container-large w-container" style="max-width: 1200px; margin: 0 auto;">
        ...
        <div class="home-hero-main-block" style="display: flex; flex-direction: column; gap: 2rem;">
            ...
            <div class="home-hero-caption-block" style="width: 100%; display: flex; flex-direction: column;">
                <div class="overflow-off">
                    <h1 class="home-hero-heading" style="text-align: center; margin-bottom: 1.5rem;">
                        <span style="font-size: clamp(24px, 4vw, 36px);"><span style="color:#0070DF">オールインワン</span>リサーチプラットフォーム</span><br>
                        アンケートを<span style="color:#0070DF">作成</span><br />
                        人々に<span style="color:#0070DF">届ける</span><br />
                        結果を<span style="color:#0070DF">理解する</span>
                    </h1>
                ...
                <div class="overflow-off">
                    <p class="hero-para-two" style="margin: 1.5rem 0; text-align: center; font-size: 15px;">
                        ユーザーフレンドリーなプラットフォーム、高度な質問タイプと調査ロジック。<br>Botではない実際の人々からの回答データ収集と結果データの可視化が可能です。
                    </p>
                </div>
                <!-- CTA Buttons -->
            ...
            <div class="home-hero-image-block">
                <div class="banner-girl-image-block">
                    <img src="./assets/images_new/researcher-back.png" alt="バナーガールイメージ" class="hero-main-image" style="max-width: 100%;">
                </div>
                <div class="banner-float-images">
                    <img src="./assets/images_new/researcher-1.png" alt="イメージ1" class="float-image">
                    <img src="./assets/images_new/researcher-2.png" alt="イメージ2" class="float-image">
                    <img src="./assets/images_new/researcher-3.png" alt="イメージ3" class="float-image">
                </div>
            </div>
        </div>
    </div>
...
<section class="strategy-section wf-section" style="background-color: #f9fafb;padding-top: 50px;background-image: url('./assets/images_new/bg4.png');background-size: cover;background-position: 0 0">
    <div class="page-container w-container">
        <div class="services-block">
            ...
            <h2 class="strategy-heading" style="font-size: 46px"><span style="color:#0070DF">高度な</span>アンケート、<span style="color:#0070DF">実際の人々からの</span>回答、<span style="color:#0070DF">素早い</span>結果の取得</h2>
                ...
                <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22d4-d8996253" class="features-services-block">
                    <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22d5-d8996253" data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22d5" class="analytics" style="background-color: #CBE5FF">
                        <div class="services-title">
                            ...
                            <div data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22d9" class="bold-text" style="color: rgb(34, 34, 34);">高性能なプラットフォーム</div>
                        </div>
                        <ul style="margin-left:-25px">
                            <li>回答者のターゲティングを精査</li>
                            <li>アンケートの質問とロジックを作成</li>
                            <li>高度なモジュール</li>
                        </ul>
                ...
                <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22e0-d8996253" data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22e0" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="features-services-block">
                    <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22e1-d8996253" data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22e1" class="analytics" style="background-color: #CBE5FF">
                        <div class="services-title">
                            ...
                            <div data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22e5" class="bold-text" style="color: rgb(34, 34, 34);">実在する回答者</div>
                        </div>
                        <ul style="margin-left:-25px">
                            <li>世界130カ国に数百万の回答者</li>
                            <li>業界をリードする高品質なパネル</li>
                            <li>独自のAIアンケート品質ソリューション</li>
                        </ul>
                ...
                <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22ec-d8996253" data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22ec" style="opacity: 1; transform: translate3d(0px, 0px, 0px) scale3d(1, 1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0deg, 0deg); transform-style: preserve-3d;" class="features-services-block">
                    <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22ed-d8996253" data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22ed" class="analytics" style="background-color: #CBE5FF">
                        <div class="services-title">
                            ...
                            <div data-w-id="fa1a0254-dc6a-ccfd-1cb6-a3a8553d22f1" class="bold-text" style="color: rgb(34, 34, 34);">質の高いデータ</div>
                        </div>
                        <ul style="margin-left:-25px">
                            <li>数分以内に一次回答データを収集</li>
                            <li>プラットフォーム上で結果を分析</li>
                            <li>データ出力も可能</li>
                        </ul>
                        <div id="w-node-fa1a0254-dc6a-ccfd-1cb6-a3a8553d22f5-d8996253" class="your-balance-block">
                            <div class="balance-image-block">
                                <img src="./assets/images_new/researcher-right.png" loading="lazy" sizes="(max-width: 479px) 85vw, (max-width: 746px) 82vw, (max-width: 991px) 612px, (max-width: 1439px) 24vw, 324.671875px" srcset="
                                                          ./assets/images_new/researcher-right.png 500w,
                                                          ./assets/images_new/researcher-right.png       612w
